  ...
  return async (dispatch) => {
    try {
      const response = await axios.post(
        " https://api-market-henry-jczt.onrender.com/pf/user/firebase",
        { email: email }
      );
      return dispatch({
...
export const addUser = (user) => {
  return async (dispatch) => {
    try {
      const response = await axios.post(
        " https://api-market-henry-jczt.onrender.com/pf/user",
        user
      );
      dispatch({
        type: ADD_USER,
  ...
  return async (dispatch) => {
    try {
      const response = await axios.put(
        `https://api-market-henry-jczt.onrender.com/PF/user/${user.id}`,
        user
      );
      const payload = response.data;
...
export const modifyFirebaseUser = (user) => {
  return async (dispatch) => {
    try {
      const response = await axios.put(
        `https://api-market-henry-jczt.onrender.com/PF/firebase/${user.id}`,
        user
      );
...
export const getAllCategories = () => {
  return async function (dispatch) {
    try {
      const response = await axios.get(
        " https://api-market-henry-jczt.onrender.com/pf/"
      );
      return dispatch({
